...
class HotPdf:
    def __init__(
        ...
        if pdf_file:
            self.load(pdf_file, password, drop_duplicate_spans, first_page, last_page, transformer)
    ...
    def load(
        ...
        Raises:
            ...
            FileNotFoundError: If the file is not found.
            PermissionError: If the file is encrypted or the password is wrong.
            RuntimeError: If an unkown error is generated by transformer.
        """
        self.__prechecks(pdf_file, first_page, last_page)
        if transformer is None:
            transformer = "g" + "s" if os.name != "nt" else "g" + "s" + "win64" + "c"

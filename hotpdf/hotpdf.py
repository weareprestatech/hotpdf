...
class HotPdf:
    def __init__(
        ...
        Args:
            ...
            add_anno (bool, optional): Add annotation spaces to the memory map.
        ...
        if pdf_file:
            self.load(pdf_file, password, page_numbers, laparams=laparams, add_anno=add_anno)
    ...
    def load(
        ...
        try:
            self.pages = processor.process(pdf_file, password, page_numbers, laparams, add_anno=add_anno)
